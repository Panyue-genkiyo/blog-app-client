                                ...
                                <>
                                    {
                                        typeof blog.profileBlogThumbnail === "string" ? (
                                                ( isEdit || isCreated  ) ?
                                                    ...
                                                    />
                                                    :
                                                    <Link to={`/blog/${blog._id}`} onClick={handleLink}>
                                                        <img src={blog.profileBlogThumbnail}
                                                             className="h-100"
                                                             alt="profileBlogThumbnail"
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">{blog.description}</p>
                            {
                                ...
                                <p className="card-text">
                                    <Link to={`/profile/${blogOwner._id}`} style={{ textDecoration: 'none' }} onClick={handleLink}>
                                        {`By ${blogOwner.name}`}
                                    </Link>
                                </p>
                            }
                                    ...
                                    >
                                        {
                                            ...
                                            <div style={{cursor: 'pointer'}}>
                                                <Link to={`/update_blog/${blog._id}`} onClick={handleLink}>
